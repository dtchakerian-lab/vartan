...
void main() {
	...
	`}var $a=class extends Jt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new gi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`,il=class extends Wc{constructor(){super(),r(this,`scene`,new Pn),r(this,`camera`,void 0),r(this,`uniforms`,Yc()),r(this,`skyUniforms`,{}),r(this,`terrainMaterial`,void 0),r(this,`skyMaterial`,void 0),r(this,`terrain`,void 0),r(this,`aspect`,1),r(this,`shake`,0),this.camera=new ra(58,1,.1,80)}init(e){this.skyMaterial=new Ai({vertexShader:el,fragmentShader:tl,uniforms:{uTime:{value:0},uAspect:{value:1},uBass:{value:0},uMid:{value:0},uTreble:{value:0},uVolume:{value:0},uBeat:{value:0},uLiveEnergy:{value:0},uBassHit:{value:0},uMidHit:{value:0},uTrebleHit:{value:0},uSectionPulse:{value:0},uLiveSpeed:{value:1},uColorA:{value:new Y},uColorB:{value:new Y},uColorC:{value:new Y},uSpectrum:{value:e.spectrumTex}},depthWrite:!1,depthTest:!1});let t=new Zr(new xi(2,2),this.skyMaterial);t.frustumCulled=!1,t.renderOrder=-1,this.scene.add(t),this.terrainMaterial=new Ai({vertexShader:nl,fragmentShader:rl,uniforms:{...this.uniforms,uHistory:{value:e.historyTex},uHistRow:{value:0}},side:2});let n=new xi(16,24,110,72);this.terrain=new Zr(n,this.terrainMaterial),this.terrain.rotation.x=-Math.PI/2.35,this.terrain.position.set(0,-1.2,-5.5),this.scene.add(this.terrain),this.skyUniforms=this.skyMaterial.uniforms,this.resize(e.width,e.height)}update(e,t){Xc(this.uniforms,e,this.aspect,t.spectrumTex);for(let e of Object.keys(this.uniforms))this.terrainMaterial.uniforms[e].value=this.uniforms[e].value;this.terrainMaterial.uniforms.uHistRow.value=t.getHistoryRow(),this.skyUniforms.uTime.value=e.time,this.skyUniforms.uAspect.value=this.aspect,this.skyUniforms.uBass.value=e.bass,this.skyUniforms.uMid.value=e.mid,this.skyUniforms.uTreble.value=e.treble,this.skyUniforms.uVolume.value=e.volume,this.skyUniforms.uBeat.value=e.beat,this.skyUniforms.uLiveEnergy.value=e.liveEnergy,this.skyUniforms.uBassHit.value=e.bassHit,this.skyUniforms.uMidHit.value=e.midHit,this.skyUniforms.uTrebleHit.value=e.trebleHit,this.skyUniforms.uSectionPulse.value=e.sectionPulse,this.skyUniforms.uLiveSpeed.value=e.liveSpeed,this.skyUniforms.uColorA.value.copy(e.colorA),this.skyUniforms.uColorB.value.copy(e.colorB),this.skyUniforms.uColorC.value.copy(e.colorC),this.skyUniforms.uSpectrum.value=t.spectrumTex;let n=e.bassHit*.7+e.midHit*.45+e.beat*.5+e.sectionPulse*.4;this.shake+=(n-this.shake)*Math.min(1,e.dt*18);let r=e.time*.04*e.liveSpeed,i=7.2-e.bass*1.4-e.liveEnergy*.6-e.sectionPulse*.9+this.shake*.35;this.camera.position.set(Math.sin(r)*.35+this.shake*.08*Math.sin(e.time*40),1+e.mid*.35+this.shake*.06,i),this.camera.lookAt(0,-.4+e.mid*.2,-8),this.terrain.position.z=-5.5-e.bass*.4-this.shake*.25}resize(e,t){this.aspect=e/t,this.camera.aspect=this.aspect,this.camera.updateProjectionMatrix()}dispose(){this.terrain.geometry.dispose(),this.terrainMaterial.dispose(),this.skyMaterial.dispose()}},al=`
precision highp float;
varying vec2 vUv;
${$c}
${Qc}
...
`,ol=class extends Wc{constructor(...e){super(...e),r(this,`scene`,new Pn),r(this,`camera`,new $i),r(this,`uniforms`,Yc()),r(this,`material`,void 0),r(this,`mesh`,void 0),r(this,`aspect`,1)}init(e){this.material=new Ai({vertexShader:Kc,fragmentShader:al,uniforms:this.uniforms,depthWrite:!1,depthTest:!1}),this.mesh=Gc(this.material),this.scene.add(this.mesh),this.aspect=e.width/e.height}update(e,t){Xc(this.uniforms,e,this.aspect,t.spectrumTex)}resize(e,t){this.aspect=e/t}dispose(){this.mesh.geometry.dispose(),this.material.dispose()}},sl=6e3,cl=`
uniform float uTime;
uniform float uBass;
uniform float uTreble;
uniform float uBeat;
...
`,ul=class extends Wc{constructor(){super(),r(this,`scene`,new Pn),r(this,`camera`,void 0),r(this,`uniforms`,Yc()),r(this,`material`,void 0),r(this,`points`,void 0),r(this,`impulse`,0),r(this,`aspect`,1),this.camera=new ra(60,1,.1,50),this.camera.position.set(0,1.2,5.5),this.camera.lookAt(0,0,0)}init(e){let t=new Or,n=new Float32Array(sl*3),r=new Float32Array(sl),i=new Float32Array(sl);for(let e=0;e<sl;e++)r[e]=Math.random(),i[e]=Math.random()**.6*3.4+.25;t.setAttribute(`position`,new pr(n,3)),t.setAttribute(`aSeed`,new pr(r,1)),t.setAttribute(`aRadius`,new pr(i,1)),this.material=new Ai({vertexShader:cl,fragmentShader:ll,uniforms:{...this.uniforms,uImpulse:{value:0},uPixelRatio:{value:e.renderer.getPixelRatio()}},transparent:!0,depthWrite:!1,blending:2}),this.points=new mi(t,this.material),this.points.frustumCulled=!1,this.scene.add(this.points),this.resize(e.width,e.height)}update(e,t){Xc(this.uniforms,e,this.aspect,t.spectrumTex);for(let e of Object.keys(this.uniforms))this.material.uniforms[e].value=this.uniforms[e].value;let n=e.beat+e.bassHit*.85+e.midHit*.55;this.impulse+=(n-this.impulse)*Math.min(1,e.dt*16),this.material.uniforms.uImpulse.value=this.impulse;let r=e.time*.05*e.liveSpeed,i=5.5-e.bass*1.6-e.liveEnergy*.8-this.impulse*.4;this.camera.position.set(Math.sin(r)*i,1.2+Math.sin(e.time*.3)*.3,Math.cos(r)*i),this.camera.lookAt(0,0,0)}resize(e,t){this.aspect=e/t,this.camera.aspect=this.aspect,this.camera.updateProjectionMatrix()}dispose(){this.points.geometry.dispose(),this.material.dispose()}},dl=`
precision highp float;
varying vec2 vUv;
${$c}
${Qc}
...
`,fl=class extends Wc{constructor(...e){super(...e),r(this,`scene`,new Pn),r(this,`camera`,new $i),r(this,`uniforms`,Yc()),r(this,`material`,void 0),r(this,`mesh`,void 0),r(this,`aspect`,1)}init(e){this.material=new Ai({vertexShader:Kc,fragmentShader:dl,uniforms:this.uniforms,depthWrite:!1,depthTest:!1}),this.mesh=Gc(this.material),this.scene.add(this.mesh),this.aspect=e.width/e.height}update(e,t){Xc(this.uniforms,e,this.aspect,t.spectrumTex)}resize(e,t){this.aspect=e/t}dispose(){this.mesh.geometry.dispose(),this.material.dispose()}},pl=`
uniform sampler2D uHistory;
uniform float uHistRow;
uniform float uBass;
uniform float uBeat;
...
`,hl=class extends Wc{constructor(){super(),r(this,`scene`,new Pn),r(this,`camera`,void 0),r(this,`uniforms`,Yc()),r(this,`material`,void 0),r(this,`mesh`,void 0),r(this,`aspect`,1),this.camera=new ra(62,1,.1,60)}init(e){let t=new xi(14,22,95,63);this.material=new Ai({vertexShader:pl,fragmentShader:ml,uniforms:{...this.uniforms,uHistory:{value:e.historyTex},uHistRow:{value:0}},side:2}),this.mesh=new Zr(t,this.material),this.mesh.rotation.x=-Math.PI/2.35,this.mesh.position.set(0,-1.1,-6),this.scene.add(this.mesh),this.resize(e.width,e.height)}update(e,t){Xc(this.uniforms,e,this.aspect,t.spectrumTex);for(let e of Object.keys(this.uniforms))this.material.uniforms[e].value=this.uniforms[e].value;this.material.uniforms.uHistRow.value=t.getHistoryRow(),this.material.uniforms.uHistory.value=t.historyTex,this.camera.position.set(Math.sin(e.time*.2)*.6,1.35+e.bass*.35+e.beat*.15,3.2),this.camera.lookAt(0,.4,-6)}resize(e,t){this.aspect=e/t,this.camera.aspect=this.aspect,this.camera.updateProjectionMatrix()}dispose(){this.mesh.geometry.dispose(),this.material.dispose()}},gl=`
precision highp float;
varying vec2 vUv;
${$c}
${Qc}
...
`,_l=class extends Wc{constructor(...e){super(...e),r(this,`scene`,new Pn),r(this,`camera`,new $i),r(this,`uniforms`,Yc()),r(this,`material`,void 0),r(this,`mesh`,void 0),r(this,`aspect`,1)}init(e){this.material=new Ai({vertexShader:Kc,fragmentShader:gl,uniforms:this.uniforms,depthWrite:!1,depthTest:!1}),this.mesh=Gc(this.material),this.scene.add(this.mesh),this.aspect=e.width/e.height}update(e,t){Xc(this.uniforms,e,this.aspect,t.spectrumTex)}resize(e,t){this.aspect=e/t}dispose(){this.mesh.geometry.dispose(),this.material.dispose()}},vl=64,yl=64,bl=class{constructor(e){r(this,`renderer`,void 0),r(this,`canvas`,void 0),r(this,`worlds`,new Map),r(this,`activeId`,`flow`),r(this,`ctx`,void 0),r(this,`spectrumTex`,void 0),r(this,`spectrumData`,void 0),r(this,`historyTex`,void 0),r(this,`historyData`,void 0),r(this,`historyRow`,0),this.renderer=new Rc({antialias:!0,preserveDrawingBuffer:!0,powerPreference:`high-performance`}),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.canvas=this.renderer.domElement,e.appendChild(this.canvas),this.spectrumData=new Uint8Array(vl),this.spectrumTex=new ei(this.spectrumData,vl,1,ge,te),this.spectrumTex.magFilter=k,this.spectrumTex.minFilter=k,this.historyData=new Uint8Array(vl*yl),this.historyTex=new ei(this.historyData,vl,yl,ge,te),this.historyTex.magFilter=k,this.historyTex.minFilter=k,this.historyTex.wrapT=C,this.ctx={renderer:this.renderer,width:1,height:1,spectrumTex:this.spectrumTex,historyTex:this.historyTex,getHistoryRow:()=>this.historyRow/yl},this.resize(),this.setWorld(`flow`)}createWorld(e){let t;switch(e){case`flow`:t=new il;break;case`aurora`:t=new ol;break;case`particles`:t=new ul;break;case`kaleidoscope`:t=new fl;break;case`waves`:t=new hl;break;case`tunnel`:t=new _l;break}return t.init(this.ctx),t.resize(this.ctx.width,this.ctx.height),t}getWorld(e){let t=this.worlds.get(e);return t||(t=this.createWorld(e),this.worlds.set(e,t)),t}setWorld(e){this.activeId=e,this.getWorld(e)}get currentWorld(){return this.activeId}updateTextures(e){let t=Math.floor(e.length*.5),n=Math.max(1,Math.floor(t/vl));for(let t=0;t<vl;t++){let r=0,i=t*n;for(let t=0;t<n;t++)r+=e[i+t];this.spectrumData[t]=r/n}this.spectrumTex.needsUpdate=!0,this.historyRow=(this.historyRow+1)%yl,this.historyData.set(this.spectrumData,this.historyRow*vl),this.historyTex.needsUpdate=!0}render(e,t){this.updateTextures(t);let n=this.getWorld(this.activeId);n.update(e,this.ctx),this.renderer.render(n.scene,n.camera)}resize(){let e=window.innerWidth,t=window.innerHeight;this.ctx.width=e,this.ctx.height=t,this.renderer.setSize(e,t);for(let n of this.worlds.values())n.resize(e,t)}dispose(){for(let e of this.worlds.values())e.dispose();this.worlds.clear(),this.renderer.dispose()}},xl=class{constructor(e){r(this,`canvas`,void 0),r(this,`ctx`,void 0),this.canvas=document.createElement(`canvas`),e.appendChild(this.canvas);let t=this.canvas.getContext(`2d`);if(!t)throw Error(`Canvas2D unavailable`);this.ctx=t,this.resize()}render(e,t){let{width:n,height:r}=this.canvas,i=this.ctx,a=n/2,o=r/2,s=e.beat+e.bassHit+e.midHit*.6;i.fillStyle=`rgba(6, 6, 14, ${.18+s*.15})`,i.fillRect(0,0,n,r);let c=Math.min(n,r)*(.14+e.bass*.08+s*.05+e.liveEnergy*.04),l=`#${e.colorA.getHexString()}`,u=`#${e.colorC.getHexString()}`;for(let s=0;s<96;s++){let d=t[Math.floor(s/96*t.length*.5)]/255,f=s/96*Math.PI*2+e.time*.25*e.liveSpeed,p=c*.15+d*Math.min(n,r)*(.28+e.liveEnergy*.12),m=a+Math.cos(f)*c,h=o+Math.sin(f)*c,g=a+Math.cos(f)*(c+p),_=o+Math.sin(f)*(c+p);i.strokeStyle=s%4==0?u:l,i.globalAlpha=.35+d*.65+e.trebleHit*.2,i.lineWidth=2+d*4+e.midHit*2,i.beginPath(),i.moveTo(m,h),i.lineTo(g,_),i.stroke()}i.globalAlpha=1,s>.02&&(i.strokeStyle=u,i.globalAlpha=s*.9,i.lineWidth=3+e.bassHit*4,i.beginPath(),i.arc(a,o,c*(1.5+(1-s)*1.4),0,Math.PI*2),i.stroke(),i.globalAlpha=1)}resize(){this.canvas.width=window.innerWidth,this.canvas.height=window.innerHeight}},Sl=`modulepreload`,Cl=function(e,t){return new URL(e,t).href},wl={},Tl=function(e,t,n){let r=Promise.resolve();if(t&&t.length>0){let e=document.getElementsByTagName(`link`),i=document.querySelector(`meta[property=csp-nonce]`),a=i?.nonce||i?.getAttribute(`nonce`);function o(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}function s(e){return import.meta.resolve?import.meta.resolve(e):new URL(e,import.meta.url).href}r=o(t.map(t=>{if(t=Cl(t,n),t=s(t),t in wl)return;wl[t]=!0;let r=t.endsWith(`.css`);for(let n=e.length-1;n>=0;n--){let i=e[n];if(i.href===t&&(!r||i.rel===`stylesheet`))return}let i=document.createElement(`link`);if(i.rel=r?`stylesheet`:Sl,r||(i.as=`script`),i.crossOrigin=``,i.href=t,a&&i.setAttribute(`nonce`,a),document.head.appendChild(i),r)return new Promise((e,n)=>{i.addEventListener(`load`,e),i.addEventListener(`error`,()=>n(Error(`Unable to preload CSS for ${t}`)))})}))}function i(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return r.then(t=>{for(let e of t||[])e.status===`rejected`&&i(e.reason);return e().catch(i)})};async function El(e){let t={title:e.name.replace(/\.[a-z0-9]+$/i,``),artist:``};try{let n=await(await Tl(()=>import(`./core-DI8d6NLn.js`),__vite__mapDeps([0,1,2,3,4,5,6,7]),import.meta.url)).parseBlob(e,{duration:!1}),r=n.common.title?.trim()||t.title,i=n.common.artist?.trim()||``,a=n.common.genre?.[0],o,s=n.common.picture?.[0];if(s&&s.data.length>0){let e=new Blob([new Uint8Array(s.data)],{type:s.format||`image/jpeg`});o=URL.createObjectURL(e)}return{title:r,artist:i,genreHint:a,embeddedArtUrl:o}}catch{return t}}var Dl=class{constructor(){r(this,`floor`,0),r(this,`ceil`,.3)}normalize(e,t){let n=1-Math.exp(-t*.3),r=1-Math.exp(-t*2.2);this.floor+=(e-this.floor)*(e>this.floor?n:r);let i=1-Math.exp(-t*8),a=1-Math.exp(-t*.25);this.ceil+=(e-this.ceil)*(e>this.ceil?i:a),this.floor=Math.min(this.floor,e),this.ceil=Math.max(this.ceil,this.floor+.07,.05);let o=Al((e-this.floor)/(this.ceil-this.floor))*.72+Al(e*1.5)*.28;return o*o*(3-2*o)}reset(){this.floor=0,this.ceil=.3}},Ol=class{constructor(){r(this,`agcBass`,new Dl),r(this,`agcMid`,new Dl),r(this,`agcTreble`,new Dl),r(this,`agcVolume`,new Dl),r(this,`prevBass`,0),r(this,`prevMid`,0),r(this,`prevTreble`,0),r(this,`sEnergy`,0),r(this,`sWarmth`,.5),r(this,`sHue`,0),r(this,`slowEnergy`,0),r(this,`sectionEnv`,0),r(this,`timeAcc`,0),r(this,`lastSectionAt`,-10),r(this,`hueDrift`,0),r(this,`hueJolt`,0)}reset(){this.agcBass.reset(),this.agcMid.reset(),this.agcTreble.reset(),this.agcVolume.reset(),this.prevBass=0,this.prevMid=0,this.prevTreble=0,this.sEnergy=0,this.sWarmth=.5,this.sHue=0,this.slowEnergy=0,this.sectionEnv=0,this.timeAcc=0,this.lastSectionAt=-10,this.hueDrift=0,this.hueJolt=0}update(e,t,n,r,i,a){let o=this.agcBass.normalize(e,a),s=this.agcMid.normalize(t,a),c=this.agcTreble.normalize(n,a),l=this.agcVolume.normalize(r,a),u=Al(Math.max(0,o-this.prevBass*.6)*3.6),d=Al(Math.max(0,s-this.prevMid*.55)*4),f=Al(Math.max(0,c-this.prevTreble*.5)*4.5);this.prevBass=o,this.prevMid=s,this.prevTreble=c;let p=Al(l*1.05+u*.25+d*.15),m=1-Math.exp(-a*22),h=1-Math.exp(-a*4.5);this.sEnergy+=(p-this.sEnergy)*(p>this.sEnergy?m:h);let{centroid:g,warmth:_}=kl(i),v=1-Math.exp(-a*16),y=1-Math.exp(-a*5);this.sWarmth+=(_-this.sWarmth)*(_>this.sWarmth?v:y);let b=(g-.5)*.38+(f-u)*.12;this.sHue+=(b-this.sHue)*(Math.abs(b-this.sHue)>.02?v:y),this.timeAcc+=a,this.slowEnergy+=(this.sEnergy-this.slowEnergy)*(1-Math.exp(-a*.12));let x=this.sEnergy-this.slowEnergy,S=Math.abs(x);if(S>.09&&this.timeAcc-this.lastSectionAt>2.5){let e=Math.min(1,S*4.5);e>this.sectionEnv&&(this.sectionEnv=e,this.lastSectionAt=this.timeAcc,this.hueJolt+=(x>0?.11:-.07)*e)}this.sectionEnv*=Math.exp(-a*.9),this.sectionEnv<.001&&(this.sectionEnv=0),this.hueDrift+=a*.006*(.35+this.sEnergy);let C=u*.55+d*.35+f*.25,w=jl(.32+this.sEnergy*2.1+C*1.4+this.sectionEnv*.5,.32,3.1);return{bass:o,mid:s,treble:c,volume:l,bassHit:u,midHit:d,trebleHit:f,liveEnergy:this.sEnergy,sectionPulse:this.sectionEnv,hueShift:this.sHue+this.hueDrift+this.hueJolt,liveSpeed:w,warmth:this.sWarmth}}};function kl(e){let t=Math.min(e.length,128),n=0,r=0,i=0,a=0,o=Math.floor(t*.35);for(let s=0;s<t;s++){let t=e[s]/255;n+=t,r+=t*s,s<o?i+=t:a+=t}return{centroid:n>1e-4?r/n/Math.max(1,t-1):.5,warmth:Al(i/(i+a+1e-4))}}function Al(e){return Math.min(1,Math.max(0,e))}function jl(e,t,n){return Math.min(n,Math.max(t,e))}function Ml(e){e.toBlob(e=>{if(!e)return;let t=URL.createObjectURL(e);Nl(t,`vartan-${Pl()}.png`),setTimeout(()=>URL.revokeObjectURL(t),5e3)},`image/png`)}function Nl(e,t){let n=document.createElement(`a`);n.href=e,n.download=t,document.body.appendChild(n),n.click(),n.remove()}function Pl(){let e=new Date,t=e=>String(e).padStart(2,`0`);return`${e.getFullYear()}${t(e.getMonth()+1)}${t(e.getDate())}-${t(e.getHours())}${t(e.getMinutes())}${t(e.getSeconds())}`}var Fl=30,Il=[`video/webm;codecs=vp9,opus`,`video/webm;codecs=vp8,opus`,`video/webm`,`video/mp4`],Ll=class{constructor(){r(this,`recorder`,null),r(this,`chunks`,[]),r(this,`stopTimer`,null),r(this,`startedAt`,0),r(this,`onTick`,null),r(this,`tickTimer`,null)}get recording(){return this.recorder!==null&&this.recorder.state===`recording`}start(e,t){if(this.recording)return!1;let n=Il.find(e=>MediaRecorder.isTypeSupported(e));if(!n)return!1;try{let r=e.captureStream(30),i=new MediaStream([...r.getVideoTracks(),...t.getAudioTracks()]);return this.chunks=[],this.recorder=new MediaRecorder(i,{mimeType:n,videoBitsPerSecond:6e6}),this.recorder.ondataavailable=e=>{e.data.size>0&&this.chunks.push(e.data)},this.recorder.onstop=()=>this.finish(n),this.recorder.start(1e3),this.startedAt=performance.now(),this.stopTimer=window.setTimeout(()=>this.stop(),Fl*1e3),this.tickTimer=window.setInterval(()=>{this.onTick?.((performance.now()-this.startedAt)/1e3)},250),!0}catch{return this.recorder=null,!1}}stop(){this.stopTimer!==null&&(clearTimeout(this.stopTimer),this.stopTimer=null),this.tickTimer!==null&&(clearInterval(this.tickTimer),this.tickTimer=null),this.onTick?.(null),this.recorder&&this.recorder.state!==`inactive`&&this.recorder.stop()}finish(e){let t=e.startsWith(`video/mp4`)?`mp4`:`webm`,n=new Blob(this.chunks,{type:e});if(this.chunks=[],this.recorder=null,n.size===0)return;let r=URL.createObjectURL(n);Nl(r,`vartan-clip-${Pl()}.${t}`),setTimeout(()=>URL.revokeObjectURL(r),1e4)}},Rl=class{constructor(){r(this,`engine`,new i),r(this,`detector`,new a),r(this,`dynamics`,new Ol),r(this,`demo`,new o(this.engine)),r(this,`recorder`,new Ll),r(this,`manager`,null),r(this,`fallback`,null),r(this,`fingerprint`,{...s}),r(this,`style`,zc(this.fingerprint)),r(this,`userPickedWorld`,!1),r(this,`source`,null),r(this,`trackLabel`,``),r(this,`loadToken`,0),r(this,`scrubbing`,!1),r(this,`el`,{hero:$(`hero`),dropzone:$(`dropzone`),heroHint:$(`hero-hint`),controls:$(`controls`),chips:$(`world-chips`),chkAuto:$(`chk-auto`),btnPlay:$(`btn-play`),seekBar:$(`seek-bar`),btnMic:$(`btn-mic`),btnDemo:$(`btn-demo`),btnSnapshot:$(`btn-snapshot`),btnRecord:$(`btn-record`),btnEject:$(`btn-eject`),btnFullscreen:$(`btn-fullscreen`),fileInput:$(`file-input`),trackTitle:$(`track-title`),timeLabel:$(`time-label`),recLabel:$(`rec-label`),analyzing:$(`analyzing`),unlockOverlay:$(`unlock-overlay`),btnUnlock:$(`btn-unlock`),toast:$(`toast`)}),r(this,`toastTimer`,null),r(this,`idleTimer`,null),r(this,`lastFrameTime`,performance.now()),r(this,`loop`,()=>{requestAnimationFrame(this.loop);let e=performance.now(),t=Math.min(.05,(e-this.lastFrameTime)/1e3);this.lastFrameTime=e;let n=e/1e3,r=this.engine.getFrame(t),i=r.bass,a=r.mid,o=r.treble,s=r.volume;if(this.source===`mic`){let e=this.engine.micLevel();s=Math.max(s,e),i=Math.max(i,e*.55),a=Math.max(a,e*.9),o=Math.max(o,e*.35)}let c=this.dynamics.update(i,a,o,s,r.spectrum,t),l=this.detector.update(c.bass,c.mid,c.treble,c.volume,n,t),u=Zc(this.style,c),d={time:n,dt:t,bass:c.bass,mid:c.mid,treble:c.treble,volume:c.volume,beat:l,bassHit:c.bassHit,midHit:c.midHit,trebleHit:c.trebleHit,liveEnergy:c.liveEnergy,sectionPulse:c.sectionPulse,liveSpeed:c.liveSpeed,energy:this.fingerprint.energy,brightness:this.fingerprint.brightness,speed:this.style.speed,colorA:u.colorA,colorB:u.colorB,colorC:u.colorC};if(this.manager?this.manager.render(d,r.spectrum):this.fallback?.render(d,r.spectrum),this.source===`file`&&this.engine.duration>0){if(this.el.seekBar.classList.remove(`hidden`),!this.scrubbing){let e=this.engine.currentTime/this.engine.duration*1e3;this.el.seekBar.value=String(Math.round(e))}this.el.timeLabel.textContent=`${zl(this.engine.currentTime)} / ${zl(this.engine.duration)}`}else if(this.source===`mic`){this.el.seekBar.classList.add(`hidden`);let e=Math.round(s*100);this.el.timeLabel.textContent=e>3?`mic ${e}%`:`mic — clap near laptop`}else this.source===`demo`?(this.el.seekBar.classList.add(`hidden`),this.el.timeLabel.textContent=`loop`):(this.el.seekBar.classList.add(`hidden`),this.el.timeLabel.textContent=``)})}start(){let e=$(`stage`);try{this.manager=new bl(e)}catch{this.fallback=new xl(e),this.el.chips.style.display=`none`}this.buildChips(),this.bindEvents(),this.loop()}async loadAudioFile(e){let t=++this.loadToken;await this.engine.unlock(),this.checkUnlocked(),this.demo.stop(),this.detector.reset(),this.dynamics.reset(),this.userPickedWorld=!1,this.source=`file`,this.el.analyzing.classList.remove(`hidden`),this.showToast(null);let n;try{n=await this.engine.loadFile(e)}catch{this.el.analyzing.classList.add(`hidden`),this.setHint(`Couldn't read that file — try an MP3, WAV, or M4A.`,!0);return}if(t===this.loadToken){this.engine.play(),this.enterLiveUi(),this.trackLabel=e.name.replace(/\.[a-z0-9]+$/i,``),this.el.trackTitle.textContent=this.trackLabel,this.resolveMeta(e,t);try{let e=await c(n);if(t!==this.loadToken)return;this.applyFingerprint(e)}finally{t===this.loadToken&&this.el.analyzing.classList.add(`hidden`)}}}applyFingerprint(e){this.fingerprint=e,this.style=zc(e),this.el.chkAuto.checked&&!this.userPickedWorld&&this.manager&&this.setWorld(Bc(e),!1)}async resolveMeta(e,t){let n=await El(e);t===this.loadToken&&(n.title&&(this.trackLabel=n.artist?`${n.artist} — ${n.title}`:n.title,this.el.trackTitle.textContent=this.trackLabel),n.genreHint&&(this.fingerprint.genreHint=n.genreHint))}async useMic(){await this.engine.unlock(),this.checkUnlocked();try{this.demo.stop(),await this.engine.useMic()}catch{this.setHint(`Microphone blocked — drop an audio file instead.`,!0);return}if(!this.engine.unlocked){this.el.unlockOverlay.classList.remove(`hidden`),this.setHint(`Tap “Enable audio” on screen, then click Mic again.`,!0);return}++this.loadToken,this.detector.reset(),this.dynamics.reset(),this.source=`mic`,this.userPickedWorld=!1,this.applyFingerprint({...s,energy:.85,brightness:.65}),this.trackLabel=`Microphone`,this.el.trackTitle.textContent=`Listening…`,this.setHint(`Clap near the laptop mic — level shows top-right.`),this.enterLiveUi()}async useDemo(){await this.engine.unlock(),this.checkUnlocked(),++this.loadToken,this.detector.reset(),this.dynamics.reset(),this.source=`demo`,this.userPickedWorld=!1,this.applyFingerprint({bpm:120,energy:.75,bassRatio:.5,brightness:.45,beatRegularity:.9}),this.demo.start(),this.trackLabel=`Demo beat`,this.el.trackTitle.textContent=`Demo beat — 120 BPM`,this.enterLiveUi()}routeFile(e){if(e.type.startsWith(`image/`)){this.showToast(`Drop an audio file — visuals react to the music itself.`);return}this.loadAudioFile(e)}eject(){++this.loadToken,this.recorder.stop(),this.demo.stop(),this.engine.stopAll(),this.source=null,this.trackLabel=``,this.el.trackTitle.textContent=``,this.el.controls.classList.add(`hidden`),this.el.hero.classList.remove(`hidden`),this.el.analyzing.classList.add(`hidden`),this.setHint(``)}enterLiveUi(){this.el.hero.classList.add(`hidden`),this.el.controls.classList.remove(`hidden`),this.el.controls.classList.remove(`faded`),this.setHint(``),this.updatePlayButton(),this.scheduleIdleFade()}buildChips(){for(let e of qc){let t=document.createElement(`button`);t.className=`chip`,t.dataset.world=e,t.textContent=Jc[e],t.addEventListener(`click`,()=>this.setWorld(e,!0)),this.el.chips.appendChild(t)}this.refreshChips()}setWorld(e,t){this.manager&&(t&&(this.userPickedWorld=!0),this.manager.setWorld(e),this.refreshChips())}refreshChips(){let e=this.manager?.currentWorld;this.el.chips.querySelectorAll(`.chip`).forEach(t=>{t.classList.toggle(`active`,t.dataset.world===e)})}updatePlayButton(){let e=this.el.btnPlay,t=this.source===`file`;e.style.display=this.source===`mic`?`none`:``,this.el.seekBar.classList.toggle(`hidden`,!t),this.source!==`mic`&&(e.textContent=(this.source===`demo`?this.demo.running:this.engine.playing)?`⏸`:`▶`)}togglePlay(){this.source===`file`?this.engine.playing?this.engine.pause():this.engine.play():this.source===`demo`&&(this.demo.running?this.demo.stop():this.demo.start()),this.updatePlayButton()}toggleRecord(){if(this.recorder.recording){this.recorder.stop(),this.el.btnRecord.classList.remove(`recording`);return}let e=this.manager?.canvas??this.fallback?.canvas;if(!(!e||!this.source)){if(!this.recorder.start(e,this.engine.recordDest.stream)){this.showToast(`Recording isn't supported in this browser.`);return}this.el.btnRecord.classList.add(`recording`),this.recorder.onTick=e=>{e===null?(this.el.recLabel.textContent=``,this.el.btnRecord.classList.remove(`recording`)):this.el.recLabel.textContent=`${Math.floor(e)}s / 30s`}}}snapshot(){let e=this.manager?.canvas??this.fallback?.canvas;e&&Ml(e)}toggleFullscreen(){document.fullscreenElement?document.exitFullscreen():document.documentElement.requestFullscreen?.()}setHint(e,t=!1){this.el.heroHint.textContent=e,this.el.heroHint.classList.toggle(`error`,t)}showToast(e){if(this.toastTimer!==null&&clearTimeout(this.toastTimer),!e){this.el.toast.classList.add(`hidden`);return}this.el.toast.textContent=e,this.el.toast.classList.remove(`hidden`),this.toastTimer=window.setTimeout(()=>{this.el.toast.classList.add(`hidden`)},3200)}checkUnlocked(){this.engine.unlocked||this.el.unlockOverlay.classList.remove(`hidden`)}scheduleIdleFade(){this.idleTimer!==null&&clearTimeout(this.idleTimer),this.el.controls.classList.remove(`faded`),this.idleTimer=window.setTimeout(()=>{this.source&&!this.recorder.recording&&this.el.controls.classList.add(`faded`)},3500)}bindEvents(){let e=this.el.dropzone;e.addEventListener(`click`,()=>this.el.fileInput.click()),e.addEventListener(`keydown`,e=>{(e.key===`Enter`||e.key===` `)&&this.el.fileInput.click()}),this.el.fileInput.addEventListener(`change`,()=>{let e=this.el.fileInput.files?.[0];this.el.fileInput.value=``,e&&this.routeFile(e)}),window.addEventListener(`dragover`,t=>{t.preventDefault(),e.classList.add(`dragover`)}),window.addEventListener(`dragleave`,t=>{(t.target===document.documentElement||!t.relatedTarget)&&e.classList.remove(`dragover`)}),window.addEventListener(`drop`,t=>{t.preventDefault(),e.classList.remove(`dragover`);let n=t.dataTransfer?.files?.[0];n&&this.routeFile(n)}),this.el.btnMic.addEventListener(`click`,()=>void this.useMic()),this.el.btnDemo.addEventListener(`click`,()=>void this.useDemo()),this.el.btnPlay.addEventListener(`click`,()=>this.togglePlay()),this.el.btnSnapshot.addEventListener(`click`,()=>this.snapshot()),this.el.btnRecord.addEventListener(`click`,()=>this.toggleRecord()),this.el.btnEject.addEventListener(`click`,()=>this.eject()),this.el.btnFullscreen.addEventListener(`click`,()=>this.toggleFullscreen()),this.el.btnUnlock.addEventListener(`click`,()=>{this.engine.unlock().then(()=>{this.engine.unlocked&&this.el.unlockOverlay.classList.add(`hidden`)})}),this.el.chkAuto.addEventListener(`change`,()=>{this.el.chkAuto.checked&&this.source&&(this.userPickedWorld=!1,this.setWorld(Bc(this.fingerprint),!1))});let t=this.el.seekBar;t.addEventListener(`pointerdown`,()=>{this.scrubbing=!0}),t.addEventListener(`pointerup`,()=>{this.scrubbing=!1}),t.addEventListener(`input`,()=>{if(this.source!==`file`||this.engine.duration<=0)return;let e=Number(t.value)/1e3*this.engine.duration;this.engine.seek(e),this.el.timeLabel.textContent=`${zl(e)} / ${zl(this.engine.duration)}`}),this.engine.onended=()=>this.updatePlayButton(),window.addEventListener(`resize`,()=>{this.manager?.resize(),this.fallback?.resize()});let n=()=>this.scheduleIdleFade();window.addEventListener(`pointermove`,n),window.addEventListener(`touchstart`,n,{passive:!0}),window.addEventListener(`keydown`,e=>{e.target instanceof HTMLInputElement||(e.code===`Space`?(e.preventDefault(),this.togglePlay()):e.key===`f`||e.key===`F`?this.toggleFullscreen():(e.key===`s`||e.key===`S`)&&this.snapshot())})}};function $(e){let t=document.getElementById(e);if(!t)throw Error(`Missing element #${e}`);return t}function zl(e){let t=Math.floor(e/60),n=Math.floor(e%60);return`${t}:${String(n).padStart(2,`0`)}`}new Rl().start();export{r as n,Tl as t};